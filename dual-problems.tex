...
\begin{figure}[h]
    ...
    The summer frontal ablation rate is tuned to give an overall constant yearly average volume.}
...
\begin{figure}[h]
    ...
    \end{center}
    \caption{Most retreated and most advanced positions of the simulated terminus overlaid on MODIS Mosaic of Greenland.}
...
In general, the total volume of ice in the simulated domain oscillates from summer lows to winter highs.
...
Figure \ref{fig:kangerd-contours} shows the most retreated and most advanced positions of the terminus during the simulation period.
...
Additionally, the true calving terminus is concave -- the centerline of the main trunk of the glacier is slightly more retreated than the margins.
The simulated terminus, on the other hand, is convex -- the centerline is more advanced than the margins.
This discrepancy shows that the ad hoc rule we used to add frontal ablation is imperfect.
...
In this paper we described the dual form of the momentum balance equation for glacier flow, an alternative expression of the same underlying physics but with different properties and several advantages.
...
Despite these disadvantages, we argue that the dual form is worth considering as an alternative to the conventional primal form of the glacier momentum balance equation because of how easy it is to simulate terminus advance and retreat.
While we do not aim to study directly the holy grail problem of calving laws, making it easier to simulate terminus evolution is a virtual requirement for testing these calving laws with computer models.
