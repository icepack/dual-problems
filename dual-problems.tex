...
\begin{table}[h]
    \begin{tabular}{cccc}
        ...
        Membrane stress & $M$ & MPa & 2 \\
        Basal stress & $\tau$ & MPa & 1 \\
        Ice thickness & $h$ & m &  \\
        Surface elevation & $s$ & m &  \\
        Flow law exponent & $n$ & &  \\
        Sliding law exponent & $m$ & &  \\
        Fluidity coefficient & $A$ & MPa${}^{-n}$ yr${}^{-1}$ &  \\
        Slipperiness coefficient & $K$ & MPa${}^{-m}$ m yr${}^{-1}$ &
    \end{tabular}
...
\begin{figure}[h]
    ...
    \caption{The viscous part $P$ of the action is shown in blue and its second derivative in orange, in (a) for the primal problem as a function of the strain rate $\dot\varepsilon$ and in (b) for the dual problem as a function of the stress $\tau$.
...
\begin{align}
    & \langle F(u), v\rangle = \nonumber\\
    & \quad \int_\Omega \left\{2hA^{-1/n}|\partial_xu^2 + \epsilon^2|^{(n - 2)/2}\partial_xu\cdot\partial_xv + \ldots\right\}dx
\end{align}
...
DRS was supported by the US National Science Foundation (grants OAC-1835321 and OAC-2411055) and National Aeronautics and Space Administration (grants 80NSSC20K0954 and 80NSSC21K1003).
